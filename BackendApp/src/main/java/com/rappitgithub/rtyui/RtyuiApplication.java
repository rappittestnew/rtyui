package com.rappitgithub.rtyui;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit", "com.vs", "com.rappitgithub.rtyui"})
@EnableCaching
...
@SecurityScheme(
    ...
    bearerFormat = "JWT")
public class RtyuiApplication {

  public static void main(String[] args) {
    SpringApplication.run(RtyuiApplication.class, args);
  }
