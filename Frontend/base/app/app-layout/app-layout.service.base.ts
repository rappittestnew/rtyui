...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"detailPagePopupWidth":70,"outline":false,"infiniteScroll":false,"urlIconFileName":"Company Logo.svg","valueChange":true,"logoFileName":"Company Logo.svg","currentNode":"29d572de-590a-464f-838b-10e1b472044f","mobileLogoFileName":"Company Logo.svg","element":"logo"},{"detailPagePopupWidth":70,"outline":false,"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"detailPagePopupWidth":70,"outline":false,"element":"appTitle"}],"middle":[{"detailPagePopupWidth":70,"outline":false,"element":"leftPane"},{"detailPagePopupWidth":70,"outline":false,"element":"middlePane"},{"detailPagePopupWidth":70,"outline":false,"element":"rightPane"}],"right":[{"children":[{"detailPagePopupWidth":70,"outline":false,"link":"/logout","label":"Logout","element":"logout"}],"element":"user"},{"detailPagePopupWidth":70,"outline":false,"menuType":"float","element":"rightMenu"}]};
